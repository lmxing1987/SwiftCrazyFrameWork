//
//  CFTabBarItemIrregularityContentView.swift
//  SwiftCrazyFrameWork
//  TabBarItem 不规则的
...
public class CFTabBarItemIrregularityBaseContentView: CFTabBarItemBouncesContentView {
    
    override init(frame: CGRect) {
        super.init(frame: frame)
        
        highlightTextColor = #colorLiteral(red: 0.2823529412, green: 0.8117647059, blue: 0.6784313725, alpha: 1)
        highlightIconColor = #colorLiteral(red: 0.2823529412, green: 0.8117647059, blue: 0.6784313725, alpha: 1)
        
        
    }
    //    重写tip的动画
    override public func badgeChangedAnimation(animated: Bool, completion: (() -> ())?) {
...
//不规则Item
public class CFTabBarItemIrregularityContentView: ESTabBarItemContentView {
