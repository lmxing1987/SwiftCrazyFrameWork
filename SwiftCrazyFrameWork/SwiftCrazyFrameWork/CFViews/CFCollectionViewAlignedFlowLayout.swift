//
//  CFCollectionViewAlignedFlowLayout.swift
//  SwiftCrazyFrameWork
//  CollectionViewAlignedFlowLayout
...
public class CFCollectionViewAlignedFlowLayout: UICollectionViewFlowLayout {
    ...
    var contentWidth: CGFloat? {
        guard let collectionViewWidth = collectionView?.frame.width else { return nil }
...
fileprivate extension UICollectionViewLayoutAttributes {
    ...
    func isRepresentingFirstItemInLine(collectionViewLayout: CFCollectionViewAlignedFlowLayout) -> Bool {
        if currentItem <= 0 {
            return true
        }
        else {
    ...
    func isRepresentingLastItemInLine(collectionViewLayout: CFCollectionViewAlignedFlowLayout) -> Bool {
    ...
    private func alignToPrecedingItem(collectionViewLayout: CFCollectionViewAlignedFlowLayout) {
    ...
    private func alignToFollowingItem(collectionViewLayout: CFCollectionViewAlignedFlowLayout) {
        let itemSpacing = collectionViewLayout.minimumInteritemSpacing
    ...
    func alignHorizontally(collectionViewLayout: CFCollectionViewAlignedFlowLayout) {
    ...
    func alignVertically(collectionViewLayout: CFCollectionViewAlignedFlowLayout) {
